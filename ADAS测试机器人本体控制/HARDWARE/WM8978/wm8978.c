...
// 	GPIO_Set(GPIOB,PIN12|PIN13,GPIO_MODE_AF,GPIO_OTYPE_PP,GPIO_SPEED_100M,GPIO_PUPD_PU);	//PB12/13/15 复用功能输出
	GPIO_Set(GPIOC,PIN6|PIN2|PIN3,GPIO_MODE_AF,GPIO_OTYPE_PP,GPIO_SPEED_100M,GPIO_PUPD_PU);	//PC2/PC3/PC6复用功能输出
//	GPIO_AF_Set(GPIOB,12,5);	//PB12,AF5  I2S_LRCK
//	GPIO_AF_Set(GPIOB,13,5);	//PB13,AF5  I2S_SCLK 
	GPIO_AF_Set(GPIOC,3,5);		//PC3 ,AF5  I2S_DACDATA 
	GPIO_AF_Set(GPIOC,2,6);		//PC2 ,AF6  I2S_ADCDATA  I2S2ext_SD是AF6!!!
 	GPIO_AF_Set(GPIOC,6,5);		//PC6 ,AF5  I2S_MCK	  
