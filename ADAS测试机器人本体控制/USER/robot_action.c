...
extern void parseCMD(void)
{
	if (cmd.dataarrive == 1)
	{
		...
		case DISABLE:
			...
			break;
		case BRAKE_ENABLE:
			send_cmd_motordrive(MOTORDRIVE_ID_LEFT, MOTORDRIVE_CMD_BRAKE_OPERATION, MOTORDRIVE_CMD_BRAKEOPERATION_ENABLE, 0);
			vTaskDelay(2);
			ERelay1 = 1;
			send_cmd_motordrive(MOTORDRIVE_ID_RIGHT, MOTORDRIVE_CMD_BRAKE_OPERATION, MOTORDRIVE_CMD_BRAKEOPERATION_ENABLE, 0);
			vTaskDelay(2);
			break;
		case BRAKE_DISABLE:
			send_cmd_motordrive(MOTORDRIVE_ID_LEFT, MOTORDRIVE_CMD_BRAKE_OPERATION, MOTORDRIVE_CMD_BRAKEOPERATION_DISABLE, 0);
			vTaskDelay(2);
			ERelay1 = 0;
			send_cmd_motordrive(MOTORDRIVE_ID_RIGHT, MOTORDRIVE_CMD_BRAKE_OPERATION, MOTORDRIVE_CMD_BRAKEOPERATION_DISABLE, 0);
			vTaskDelay(2);
			break;
		case SUB_TURN:
			paraseTurnCmd();
